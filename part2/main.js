...
var $author$project$Main$initialModel = {description: '', loggedIn: false, name: '', status: ''};
...
var $author$project$Main$SaveDescription = function (a) {
	return {$: 'SaveDescription', a: a};
};
var $author$project$Main$SaveName = function (a) {
	return {$: 'SaveName', a: a};
};
var $author$project$Main$SaveStatus = function (a) {
...
var $author$project$Main$styledButton = A2(
...
var $author$project$Main$styledForm = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
...
var $author$project$Main$styledInput = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
...
var $author$project$Main$view = function (user) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Enter a task in the To Do List')
					])),
				A2(
				$author$project$Main$styledForm,
				_List_Nil,
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								A2(
								$author$project$Main$styledInput,
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$id('name'),
										$rtfeldman$elm_css$Html$Styled$Attributes$type_('text'),
										$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Main$SaveName)
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$id('description'),
										$rtfeldman$elm_css$Html$Styled$Attributes$type_('description'),
										$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Main$SaveDescription)
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$id('status'),
										$rtfeldman$elm_css$Html$Styled$Attributes$type_('status'),
										$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Main$SaveStatus)
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								A2(
								$author$project$Main$styledButton,
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$type_('submit'),
										$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$Signup)
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Create a Item in the To Do List')
									]))
							]))
					]))
			]));
